...
#       undef STAT
    ...
    virtual InlineCost getInlineCost(CallSite CS) {
		...
		std::function<AssumptionCache &(Function &)> gac(getAssumptionCache);
                InlineCost Cost = llvm::getInlineCost(CS, IP, TTI, gac, nullptr);
                if (Cost)
